...
function createFilterDropdowns() {
  ...
  recipes.forEach((recipe) => {
    ...
    recipe.ustensils.forEach(function (ustensils) {
      utensilsArray.push(ustensils.toLowerCase());
    });

    devicesArray.push(recipe.appliance.toLowerCase());
  });

  //call uniq funtion so there is no repetition
  ingredientArray = uniq(ingredientArray);
  devicesArray = uniq(devicesArray);
  utensilsArray = uniq(utensilsArray);
    ...
    item.addEventListener("click", function () {
      ...
      if (!array.includes(criteria)) {
        ...
        close.addEventListener("click", function () {
          //removes tag and removes filter from array
      ...
      //clear recipe array to not repeat recipes
...
// Check for repetition in arrays
function uniq(a) {
